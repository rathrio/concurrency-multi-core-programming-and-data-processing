 ...
 */
public class SplitOrderHashSet<T> implements Set<T> {
   ...
   */
  public SplitOrderHashSet(int capacity) {
  ...
  public boolean add(T x) {
    ...
    if (setSizeNow / (double)bucketSizeNow > THRESHOLD && bucket.length <= 2 * bucketSizeNow)
